...
// rubric35 - The user should the name of the selected product 
// rubric36 - The user should an image of the selected product 
  ...
  render() {
    ...
    if (this.state.sort === false) {
      itemList = (
        <div
          className="main-div"
          style={{ marginLeft: '-25px', marginBottom: '57px' }}
        >
